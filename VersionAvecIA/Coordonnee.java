...
public class Coordonnee {
	...
	public boolean compareCoord(Coordonnee start, Coordonnee end) { // permet de savoir quelle est la coordonnée la
																	// "plus" grande
	...
	public Coordonnee coordRandomMiddle() {
		Random rdL = new Random();
